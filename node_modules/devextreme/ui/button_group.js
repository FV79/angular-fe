...
var ButtonGroup = _ui2.default.inherit({
    ...
    _prepareItemStyles: function($item) {
        ...
        (0, _type.isDefined)(width) && $item.addClass(BUTTON_GROUP_ITEM_HAS_WIDTH);
    ...
    _renderButtons: function() {
        ...
        var options = {
            ...
            noDataText: "",
            selectionRequired: "single" === this.option("selectionMode"),
    ...
    _optionChanged: function(args) {
        ...
        switch (args.name) {
            ...
            case "width":
                this.callBase(args);
                var $items = this.$element().find("." + BUTTON_GROUP_ITEM_CLASS);
