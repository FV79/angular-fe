    ...
    return {
        ...
        updateFieldValue: function(options, value, text, forceUpdateRow) {
            var params, columns, that = this,
                ...
                editMode = _getEditMode(that);
            if (void 0 === rowKey) {
                that._dataController.dataErrorOccurred.fire(_ui2.default.Error("E1043"))
            }
        ...
        _createButton: function($container, button, options) {
            ...
            if (button.template) {
                ...
                _events_engine2.default.on($button, (0, _utils.addNamespace)(_click2.default.name, EDITING_NAMESPACE), that.createAction(function(e) {
