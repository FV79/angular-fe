...
@Component({
  selector: 'app-productos-fact',
  templateUrl: './productos-fact.component.html',
  styleUrls: ['./productos-fact.component.css']
})
export class ProductosFactComponent implements OnInit {
  //TabControl de productos
  pestanasCliente =[{
    id:1,
    nombrePestanaCliente:'Lista Productos'
  },
  {
    id:2,
    nombrePestanaCliente:'Agregar Producto'
  },
  {
    id:3,
    nombrePestanaCliente:'Catologo de Productos SAT'
  },
  {
    id:4,
    nombrePestanaCliente:'Catalogo de Unidades de Medida SAT'
  }]
